...
const Penutup = () => {
  return (
    <section className="py-24 px-6 bg-[var(--color-cream)] text-center relative overflow-hidden flex flex-col items-center justify-center min-h-[60vh]">
      ...
      <FadeIn className="relative z-10 max-w-2xl mx-auto bg-white/60 backdrop-blur-md p-12 rounded-3xl shadow-sm border border-[var(--color-cream-dark)]">
