  ...
  return (
    <section className="py-24 px-6 bg-white text-center">
      <FadeIn className="max-w-4xl mx-auto">
        ...
        {/* Google Maps Embed */}
        <div className="w-full h-80 md:h-[400px] rounded-2xl overflow-hidden shadow-xl mb-8 border-4 border-[var(--color-cream-dark)]">
          <iframe 
        ...
        <a 
          ...
          className="inline-block px-8 py-3 bg-[var(--color-gold)] text-white font-sans tracking-widest text-sm uppercase rounded-full hover:bg-[#a38965] transition-colors shadow-lg"
        >
          Buka di Google Maps
        </a>
      </FadeIn>
