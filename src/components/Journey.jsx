  ...
  return (
    <section className='py-24 px-6 bg-white overflow-hidden'>
      <FadeIn className='text-center mb-16'>
        ...
        />
        <p className='font-sans text-gray-500 font-light max-w-lg mx-auto'>Perjalanan singkat cerita cinta kami.</p>
      </FadeIn>

      <div
        className='max-w-6xl mx-auto flex overflow-x-auto snap-x snap-mandatory gap-6 pb-8 px-4'
      ...
      >
        {stories.map((story, index) => (
          ...
          >
            <div className='bg-cream-dark rounded-2xl overflow-hidden shadow-lg h-full flex flex-col'>
              ...
              <div className='p-8 flex-grow flex flex-col justify-center text-center'>
                ...
                <p className='font-sans text-sm text-gray-600 font-light leading-relaxed'>{story.desc}</p>
              </div>
            </div>
          </FadeIn>
        ))}
